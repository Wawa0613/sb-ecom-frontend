...
const ProductCard = ({
    ...
    return (
        <div className="border rounded-lg shadow-xl overflow-hidden transition-shadow duration-300 flex flex-col h-[400px]">
            <div 
                onClick={() => {
                    handleProductView({
                        id: productId,
                ...
                className="w-full h-1/2 min-h-[200px] max-h-[200px] bg-gray-100 flex items-center justify-center overflow-hidden">
                <img 
